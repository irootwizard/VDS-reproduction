...
RSA_DIR = os.path.join(PROJECT_ROOT, 'RSA-accumulator')
...
GENERATED_CSV_DIRECTORY = os.path.join(PROJECT_ROOT, 'results', 'rsa_accumulator', 'raw')
os.makedirs(GENERATED_CSV_DIRECTORY, exist_ok=True)
...
print('Done - written results to ' + GENERATED_CSV_DIRECTORY)
